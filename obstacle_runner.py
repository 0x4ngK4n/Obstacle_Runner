...
pygame.init()
screen = pygame.display.set_mode((800,400)) # Game window size
...
# Obstacles are part of Group
obstacle_group = pygame.sprite.Group()


# Player is GroupSingle
...
player_gravity = 0  # Initial gravity value. Graive +ive makes player fall, -ive makes player rise
gravity_index = 1   # rate at which you want player to rise or fall in Gravity
...
intro_surface = text_font.render('Runner', False,(64,64,64))
intro_surface_rect = intro_surface.get_rect(center=(400,50))
